...
public class OutgoingVinsNoActivity$$ViewBinder<T extends com.ikt.main.to.activities.OutgoingVinsNoActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131755446, "field 'txtAmountVin'");
    target.txtAmountVin = finder.castView(view, 2131755446, "field 'txtAmountVin'");
