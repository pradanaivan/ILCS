...
public class LoginActivity$$ViewBinder<T extends com.ikt.main.to.activities.LoginActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131755371, "field 'edtPassword'");
    target.edtPassword = finder.castView(view, 2131755371, "field 'edtPassword'");
    view = finder.findRequiredView(source, 2131755372, "field 'btnLogin'");
    target.btnLogin = finder.castView(view, 2131755372, "field 'btnLogin'");
  }
