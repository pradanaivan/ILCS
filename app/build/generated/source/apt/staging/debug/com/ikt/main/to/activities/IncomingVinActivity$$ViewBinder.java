...
public class IncomingVinActivity$$ViewBinder<T extends com.ikt.main.to.activities.IncomingVinActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131296731, "field 'txtAmountVin'");
    target.txtAmountVin = finder.castView(view, 2131296731, "field 'txtAmountVin'");
