...
public abstract class CarouselSpinner extends CarouselMenuAdapter<SpinnerAdapter> {
    ...
    /**
     * Jump directly to a specific item_carousel in the adapter data.
     */
    ...
    /**
     * Makes the item_carousel at the supplied position selected.
     * 
     ...
     * UNSPECIFIED. The height is based on the height of the selected item_carousel
     * plus padding. 
     */
     ...
     * @return The position of the item_carousel which contains the specified point, or
     *         {@link #INVALID_POSITION} if the point does not intersect an item_carousel.
     */
