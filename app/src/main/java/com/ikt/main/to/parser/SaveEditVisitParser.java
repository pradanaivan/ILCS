...
/**
 * Created by Arifin on 9/29/16.
 */

public class SaveEditVisitParser extends DefaultErrorModel implements IParser {
...
//            }
            ...
            if(jsonObject != null){
                VectorModel.getInstance().clearSaveTicketObjects();
                ...
                VectorModel.getInstance().setSaveTicketObjects(editTicketObject);
            }
        } catch (JSONException e) {
            setError(e.getMessage());
        }
