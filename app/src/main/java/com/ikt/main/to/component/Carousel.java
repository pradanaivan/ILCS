...
public class Carousel extends CarouselSpinner implements GestureDetector.OnGestureListener {
    ...
    /**
     * The position of the item_carousel that received the user's down touch.
     */
    private int mDownTouchPosition;
    /**
     * The view of the item_carousel that received the user's down touch.
     */
    ...
    /**
     * The currently selected item_carousel's child.
     */
    private View mSelectedChild;
    /**
     * Whether to continuously callback on the item_carousel selected listener during a
     * fling.
     */
    private boolean mShouldCallbackDuringFling = true;
    /**
     * Whether to callback when an item_carousel that is not selected is clicked.
     */
     ...
     * rightmost item_carousel, we will set this to true.
     */
    private boolean mShouldStopFling;
    /**
     * If true, do not callback to item_carousel selected listener.
     */
    ...
    protected int computeHorizontalScrollExtent() {
        // Only 1 item_carousel is considered to be selected
        return 1;
    }
    ...
    protected int computeHorizontalScrollRange() {
        // Scroll range is the same as the item_carousel count
        return mItemCount;
    }
    ...
    /**
     * Extra information about the item_carousel for which the context menu should be shown.
     */
    @Override
    ...
    protected void onFocusChanged(boolean gainFocus, int direction, Rect previouslyFocusedRect) {
        ...
        /*
         * The gallery shows focus by focusing the selected item_carousel. So, give
         * focus to our selected item_carousel instead. We steal keys from our
         * selected item_carousel elsewhere.
         */
    ...
    protected int getChildDrawingOrder(int childCount, int i) {
        ...
        // Get first undrawn item_carousel in array and get result index
        int idx = 0;
    ...
    /**
     * Transform an item_carousel depending on it's coordinates
     */
    @Override
    ...
    public void setSelectedPositionInt(int position) {
        ...
        // Updates any metadata we keep about the selected item_carousel.
        updateSelectedItemMetadata();
    }
    ...
    public boolean onDown(MotionEvent e) {
        ...
        // Get the item_carousel's view that was touched
    ...
    /**
     * Brings an item_carousel with nearest to 0 degrees angle to this angle and sets it selected
     */
    private void scrollIntoSlots() {
        ...
        // get nearest item_carousel to the 0 degrees angle
     ...
     * while the items are being flinged. If false, only the final selected item_carousel
    ...
    /**
     * Whether or not to callback when an item_carousel that is not selected is clicked.
     * If false, the item_carousel will become selected (and re-centered). If true, the
     * {@link #getOnItemClickListener()} will get the callback.
     *
     * @param shouldCallback Whether or not to callback on the listener when a
     *                       item_carousel that is not selected is clicked.
     * @hide
     */
     ...
     * movement to items (touch scroll, arrow-key scroll, set an item_carousel as selected).
     *
